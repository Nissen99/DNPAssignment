...
namespace SimpleLogin.LoginFunctionality
{
    public class CustomAuthenticationStateProvider : AuthenticationStateProvider { 
        ...
        public CustomAuthenticationStateProvider(IUserClient userClient, IJSRuntime jSRuntime)
        {
     ...
     */
        ...
        public async Task ValidateLoginAsync(string username, string password) {
            ...
            try {
                user = await _userClient.ValidateLoginAsync(username, password);
                if (user != null) {
